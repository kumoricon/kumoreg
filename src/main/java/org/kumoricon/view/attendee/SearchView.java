...
public class SearchView extends VerticalLayout implements View{
    ...
    public void init() {
        ...
        tblResult.setColumnHeaders(new String[] { "First Name", "Last Name", "Badge Name", "Age", "Zip", "Checked In"});

        tblResult.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            @Override
